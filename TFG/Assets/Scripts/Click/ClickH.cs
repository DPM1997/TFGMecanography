...
public class ClickH : MonoBehaviour
{
    bool inside;
    ...
    void Update()
    {
        if (Input.GetKeyDown(KeyCode.H) && inside == true){
          ...
          inside=false;
        } else if(Input.GetKeyDown(KeyCode.H) && inside == false){
            score = score -1;
            text.text=(""+score);
        }
